...
import "./GeographicRevenueChart.css";
...
export function GeographicRevenueChart({ rows }: { rows: Row[] }) {
  return (
    <div className="atlas-geo-chart">
      <ResponsiveContainer width="100%" height={240}>
        <BarChart data={rows} margin={{ top: 8, right: 12, bottom: 0, left: 0 }}>
          ...
          />
          <Bar dataKey="revenue" name="Revenue" fill={COLOR_ACCENT} radius={[3, 3, 0, 0]} />
        </BarChart>
      </ResponsiveContainer>
    </div>
  );
